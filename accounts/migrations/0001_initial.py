# Generated by Django 5.2.4 on 2025-09-01 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('profile_picture', models.ImageField(upload_to='profile')),
                ('business_name', models.CharField(blank=True, default='None', max_length=191, null=True)),
                ('phn_no', models.CharField(max_length=10, unique=True)),
                ('email_token', models.CharField(blank=True, max_length=191, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.hotelvendor')),
            ],
        ),
        migrations.CreateModel(
            name='HotelImages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.hoteluser')),
            ],
        ),
    ]
